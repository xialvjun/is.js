...
exports.is = {
    optional: function (validates) { return function (input) {
    ...
    default: function (default_value, default_generator) { return function (input) {
        var output = input, error = null, is_valid = true;
        if ([undefined, null, "", 0].indexOf(input) > -1 ||
            (js_utils_1.to_string(input) === "[object Array]" && input.length === 0)) {
